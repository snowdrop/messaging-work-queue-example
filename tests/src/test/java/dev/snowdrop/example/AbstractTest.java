...
public abstract class AbstractTest {
    ...
    protected abstract URL getFrontendUrl() throws MalformedURLException;

    @BeforeEach
    public void before() throws MalformedURLException {
        dataUrl = new URL(getFrontendUrl(), "api/data");
        requestUrl = new URL(getFrontendUrl(), "api/send-request");
        responseUrl = new URL(getFrontendUrl(), "api/receive-response");
    }
